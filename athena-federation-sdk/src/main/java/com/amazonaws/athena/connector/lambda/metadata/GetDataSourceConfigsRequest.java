...
public class GetDataSourceConfigsRequest
        extends MetadataRequest
{
     ...
     */
    @JsonCreator
    public GetDataSourceConfigsRequest(@JsonProperty("identity") FederatedIdentity identity,
                                       @JsonProperty("queryId") String queryId,
                                       @JsonProperty("catalogName") String catalogName)
    {
        super(identity, MetadataRequestType.GET_DATASOURCE_CONFIGS, queryId, catalogName);
    }
    ...
    {
        return "GetDataSourceConfigsRequest{" +
    ...
    public boolean equals(Object o)
    {
        ...
        GetDataSourceConfigsRequest that = (GetDataSourceConfigsRequest) o;
